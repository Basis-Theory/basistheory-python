...
class DetokenizeApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.detokenize_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'apiKey'
                ],
                'endpoint_path': '/detokenize',
    ...
    def detokenize(
        ...
        **kwargs
        ...
        >>> thread = api.detokenize(async_req=True)
        >>> result = thread.get()
        ...
        return self.detokenize_endpoint.call_with_http_info(**kwargs)
