...
class ReactorsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.reactors_delete_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'apiKey'
        ...
        self.reactors_update_endpoint = _Endpoint(
            settings={
                'response_type': (Reactor,),
                'auth': [
                    'apiKey'
    ...
    def reactors_delete(
        ...
        **kwargs
        ...
        """reactors_delete  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.reactors_delete(id, async_req=True)
        >>> result = thread.get()
    ...
    def reactors_update(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.reactors_update_endpoint.call_with_http_info(**kwargs)
