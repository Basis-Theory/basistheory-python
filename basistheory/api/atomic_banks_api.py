...
class AtomicBanksApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_endpoint = _Endpoint(
            settings={
                'response_type': (AtomicBankModel,),
                'auth': [
                    'apiKey'
                ],
                'endpoint_path': '/atomic/banks',
                'operation_id': 'create',
                'http_method': 'POST',
                'servers': None,
            },
        ...
        self.get_decrypted_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/atomic/banks/{id}/decrypt',
        ...
        self.list_endpoint = _Endpoint(
            settings={
                'response_type': (AtomicBankModelPaginatedList,),
                'auth': [
                    'apiKey'
                ],
                'endpoint_path': '/atomic/banks',
        ...
        self.react_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/atomic/banks/{bankId}/react',
                'operation_id': 'react',
                'http_method': 'POST',
                'servers': None,
            },
    ...
    def create(
        ...
        **kwargs
        ...
        Keyword Args:
            create_atomic_bank_model (CreateAtomicBankModel): [optional]
    ...
    def update(
        ...
        **kwargs
        ...
        Keyword Args:
            update_atomic_bank_model (UpdateAtomicBankModel): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
