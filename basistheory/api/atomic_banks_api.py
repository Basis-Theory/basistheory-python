...
class AtomicBanksApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.list_endpoint = _Endpoint(
            settings={
                'response_type': (PaginatedAtomicBankList,),
                'auth': [
                    'apiKey'
                ],
                'endpoint_path': '/atomic/banks',
    ...
    def create(
        ...
        **kwargs,
        ...
        Args:
            atomic_bank (AtomicBank): Atomic bank to create
    ...
    def delete(
        ...
        **kwargs
        ...
        Args:
            id (str): id for the atomic bank to delete
