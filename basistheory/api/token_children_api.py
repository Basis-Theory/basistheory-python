...
class TokenChildrenApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.associate_child_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'apiKey'
    ...
    def associate_child(
        ...
        **kwargs
        ...
        """associate_child  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.associate_child(parent_id, child_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['child_id'] = \
            child_id
        return self.associate_child_endpoint.call_with_http_info(**kwargs)
