...
class BanksApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_endpoint = _Endpoint(
            ...
            root_map={
                ...
                'location_map': {
                    'create_atomic_bank_request': 'body',
                },
        ...
        self.get_endpoint = _Endpoint(
            settings={
                'response_type': (AtomicBankPaginatedList,),
                'auth': [
                    'apiKey'
                ],
                'endpoint_path': '/atomic/banks',
        ...
        self.get_byid_endpoint = _Endpoint(
            settings={
                'response_type': (AtomicBank,),
                'auth': [
                    'apiKey'
        ...
        self.update_endpoint = _Endpoint(
            ...
            root_map={
                ...
                'location_map': {
                    'id': 'path',
                    'update_atomic_bank_request': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def get_byid(
        ...
        **kwargs
        ...
        >>> thread = api.get_byid(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.get_byid_endpoint.call_with_http_info(**kwargs)
