...
def lazy_import():
    ...
    globals()['TenantConnectionOptions'] = TenantConnectionOptions


class CreateTenantConnectionRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'options': (TenantConnectionOptions,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, strategy, options, *args, **kwargs):  # noqa: E501
        """CreateTenantConnectionRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, strategy, options, *args, **kwargs):  # noqa: E501
        """CreateTenantConnectionRequest - a model defined in OpenAPI
